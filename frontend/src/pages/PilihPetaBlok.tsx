    ...
    <div className="space-y-6">
      {step === 'blok' && (
        <button
          ...
          className="flex items-center gap-2 text-green-500 hover:text-green-600 dark:hover:text-green-400 font-medium bg-transparent border-none focus:outline-none transition mb-2"
        >
